...
> Real Estate AI Analysis Dashboard — part of the [Cocapn](https://cocapn.ai) ecosystem

![Build](https://img.shields.io/badge/build-passing-brightgreen) ![License](https://img.shields.io/badge/license-MIT-blue) ![TypeScript](https://img.shields.io/badge/TypeScript-24_files-blue) ![Lines](https://img.shields.io/badge/lines-4550-green)

## Description

Real Estate AI Analysis Dashboard. Part of the Cocapn ecosystem of AI-powered log and analysis tools.

## ✨ Features

- AI-powered Real Estate AI Analysis Dashboard\n- BYOK multi-provider LLM support\n- Real-time data processing\n- Claude Code optimized

## 🚀 Quick Start

```bash
git clone https://github.com/Lucineer/reallog-ai.git
cd reallog-ai
npm install
npx wrangler dev
```
...
- 🌐 **Live**: https://reallog-ai.magnus-digennaro.workers.dev
- ❤️ **Health**: https://reallog-ai.magnus-digennaro.workers.dev/health
- ⚙️ **Setup**: https://reallog-ai.magnus-digennaro.workers.dev/setup
